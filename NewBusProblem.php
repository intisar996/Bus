...
$today = date('Y-m-d');
$q="select * from  tblbusproblem P,tblbus B where  P.Bus_id=B.Bus_id and P.Problem_status='New'";
...
if ($num > 0) {
  ...
  while($row = mysqli_fetch_assoc($r)) {
     ...
     $Problem_id=$row["Problem_id"];
       ...
       echo '<td><a href="Repair.php?Problem_id='.$Problem_id .'" class="btn-Clear">Repair</a></td>';
	...
	echo "<center>No New Problem Yet! <br>";
