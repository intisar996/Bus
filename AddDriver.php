       ...
       <div class="back">
        <div class="container">
            <div class="row">
                <div class="Register">
                     <h1>Register Form</h1>
                    <form action="AddDriver_Code.php" method="post">
                        <table>
                            <tr>
                                <td><label for="">Civil ID</label>
                                    <input type="text" name="D_id" class="form-control"  maxlength="8" id="D_id"  placeholder="Enter Driver Civil Number" style="width:300px;height:45px;border-radius:20px;margin:auto;"  required>
                                    <div id="result" style="width: 300px"></div>				
                                  </td>
                                <td ><label for="">Driver Name</label>
                                    <input type="text" name="dname" class="form-control"  maxlength="50"   placeholder="Enter Driver Name" pattern="[a-zA-Z ]+"  required title="Please enter a name using only letters"  style="width:300px;height:45px;border-radius:20px;margin:auto;"  required>
                                  </td>
                            </tr>
                            <tr>
                                <td><label for="">Driver Email</label>
                                    <input type="email" name="email" class="form-control"  maxlength="35"   placeholder="Enter Driver Email" style="width:300px;height:45px;border-radius:20px;margin:auto;"  required>
                                  </td>
                                <td ><label for="">Driver Phone</label>
                                    <input type="text" name="phone" class="form-control"  maxlength="8"   placeholder="Enter Driver Phone"  pattern="[7|9|2][0-9]{7}" required title="Please enter a phone number starting with 7, 9, or 2 and has a total of 8 digits" style="width:300px;height:45px;border-radius:20px;margin:auto;"  required>
                            </tr>
                            <tr>
                       ...
                       <input type="text" name="answer"  maxlength="25" class="form-control" placeholder="Enter Your Answer" style="width:300px;height:45px;border-radius:20px;margin:auto;"  required>
                            </td>
                            </tr>
                      <tr>                  
                        <td> <label for="">Address</label>
                          <input type="text" name="address"  maxlength="25" class="form-control" placeholder="Enter Driver  Address"   style="width:300px;height:45px;border-radius:20px;margin:auto;" required>
                        </td>
