        ...
        <div class="container-fluid">
            ...
            <form action="Search_Passenger.php" method="post">
                    <table class="tb-search">
                        <tr>
                            <td><input type="text" class="form-control" width="100" name="pid"
                                    placeholder="Enter Passenger ID" id="" style="width:300px;height:45px;padding:15px" required>
                            </td>
                            <td>
                                <input type="submit" value="Search" class="btn-search">
                                <a href="ListPassenger.php"><input type="button" value="Clear"
                                        class="btn-Clear"></a>
                            </td>
                        </tr>
                    </table>
...
$query_count = "SELECT COUNT(*) AS total FROM tbipassanger ";
$result_count = mysqli_query($con, $query_count);
$row_count = mysqli_fetch_assoc($result_count);
$total_records = $row_count['total'];
$total_pages = ceil($total_records / $records_per_page);

$q="select * from  tbipassanger  order by pname LIMIT $offset, $records_per_page";
