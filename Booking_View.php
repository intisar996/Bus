                     ...
                     <nav class="navigation navbar navbar-expand-md navbar-dark ">
                        ...
                        <div class="collapse navbar-collapse" id="navbarsExample04">
                           <ul class="navbar-nav mr-auto">
                               ...
                               <li class="nav-item" href="#">
                                 <a class="nav-link" href="Admin_ListBooking.php">Back</a>
                             </li>
                               <li class="nav-item" href="#">
...
$query_count = "SELECT COUNT(*) AS total FROM tblpayment ";
...
$today = date('Y-m-d');
$q="select * from  tblpayment P, tblticket T, tblbus B,tbldriver D,tbipassanger I  where  P.Ticket_id=T.Ticket_id and T.Bus_id=B.Bus_id and T.D_id=D.D_id and I.pid=P.pid and T.Ticket_id='$Ticket_id' order by P.booking_date   LIMIT $offset, $records_per_page";
...
if ($num > 0) {
	...
	while($row = mysqli_fetch_assoc($r)) {
        ...
        echo "<td>$T_date</td>";
        echo "<td>$T_time</td>";
        echo "<td>$Number_ofTicket</td>";
        echo "<td>$Total_Price</td>";
        echo "<td>$bus_from</td>";
        echo "<td>$bus_to</td>";
        echo "<td>$pid</td>";
        echo "<td>$pname</td>";
        echo '<td><a href="printTicket_Page1.php?Ticket_id='.$Ticket_id .'" class="btn-Clear">Print</a></td>';
        echo '</tr>';
    }
