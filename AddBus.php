       ...
       <div class="back">
        <div class="container">
            <div class="row">
                <div class="Register">
                     <h1>Add New Bus</h1>
                    <form action="AddBus_Code.php" method="post">
                        <table>
                            <tr>
                                <td><label for="">Bus Name</label>
                                    <input type="text" name="Bus_Name" class="form-control"  maxlength="35" id="Bus_Name"  placeholder="Enter Bus Name" style="width:300px;height:45px;border-radius:20px;margin:auto;"  required>
                                    <div id="result" style="width: 300px"></div>				
                                  </td>
                                <td ><label for="">Bus Capacity</label>
                                    <input type="number" name="Capacity" class="form-control"  maxlength="2"   placeholder="Bus Capacity" style="width:300px;height:45px;border-radius:20px;margin:auto;"  required>
                                  </td>
                            </tr>
                        
                            <tr>
                              <td colspan="2">
                                <input type="submit" class="Submit_btn" value="Add Bus">
