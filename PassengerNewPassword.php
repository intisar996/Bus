...
.Register table {
 ...
 include('connect.php');
 $UserID=$_GET['pid'];
 $q="select * from  tbipassanger where pid='$UserID'";
        ...
        <div class="container">
            <div class="row">
                <div class="Register">
                     ...
                     <hr>
                     <form   method="post" id="form2"   name="form2"  onsubmit="return validate(this);"  enctype="multipart/form-data" action="<?php echo "PassengerUpdatePassword.php?pid=$UserID";?>" >
                    <table>
                      <tr>
