   ...
   <body class="main-layout">
      ...
      <div class="content">
        <div class="container-fluid">
            <div class="search">
            <form action="Search_Ticket1.php" method="post">
                    <table class="tb-search">
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="Ticket.php"><input type="button" value="Clear"
                                        class="btn-Clear"></a>
                            </td>
                        </tr>
                    </table>
...
$T_date=$_POST['T_date'];
$today = date('Y-m-d');
$q="select * from  tblticket T, tblbus B,tbldriver D  where  (T.state='$state' and T.T_date='$T_date') and B.Bus_id=T.Bus_id and D.D_id=T.D_id and T.T_date >= '$today'  and T.Tstatus='0'  and available_ticket!='0' order by T.T_date  LIMIT $offset, $records_per_page";
...
if ($num > 0) {
	...
	while($row = mysqli_fetch_assoc($r)) {
        ...
        echo "<td>$bus_from</td>";
        echo "<td>$bus_to</td>";
        echo '<td><a href="BookingForm.php?Ticket_id='.$Ticket_id .'" class="btn-Update"><img src="images/booking.png"></a></td>';
        echo '</tr>';
    }
