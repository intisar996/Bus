   ...
   <body class="main-layout">
      ...
      <div class="content">
        <div class="container-fluid">
            <div class="search">
            <form action="Search_DriverTiming.php" method="post">
                    <table class="tb-search">
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="ListDriverTiming.php"><input type="button" value="Clear"
                                        class="btn-Clear"></a>
                            </td>
                        </tr>
                    </table>
...
$today = date('Y-m-d');
$q="select * from  tblticket T, tblbus B,tbldriver D  where  B.Bus_id=T.Bus_id and D.D_id=T.D_id   order by T.T_date DESC  LIMIT $offset, $records_per_page";
...
if ($num > 0) {
  ...
  while($row = mysqli_fetch_assoc($r)) {
     ...
     $bus_to=$row["bus_to"];
       ...
       echo "<td>$bus_from</td>";
       echo "<td>$bus_to</td>";
       echo '<td><a href="ListBooking.php?Ticket_id='.$Ticket_id .'" class="btn-Clear">Booking</a></td>';
       echo '</tr>';
    }
