        ...
        <div class="container">
            <div class="row">
                <div class="Register">
                    ...
                    <form action="UpdateDriverProfile_Code.php" method="post">
                        <table>
                            <tr>
                                <td><label for="">Driver ID</label>
                                    <input type="text" name="D_id" class="form-control"  maxlength="35" id="D_id"  value="<?php echo $D_id ?>"  style="width:300px;height:45px;border-radius:20px;margin:auto;"  readonly>
                                  </td>
                            ...
                            <tr>
                            <td ><label for="">Driver Address</label>
                                    <input type="text" name="address" class="form-control"  maxlength="35" value="<?php echo $address ?>"    placeholder="Enter Driver Address" style="width:300px;height:45px;border-radius:20px;margin:auto;"  required>
                                  </td>
                            </tr>
                            <tr>
                              <td colspan="2">
