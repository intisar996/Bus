                     ...
                     <nav class="navigation navbar navbar-expand-md navbar-dark ">
                        ...
                        <div class="collapse navbar-collapse" id="navbarsExample04">
                           <ul class="navbar-nav mr-auto">
                               ...
                               <li class="nav-item" href="#">
                                 <a class="nav-link" href="ManageTicket.php">Back</a>
                             </li>
                               <li class="nav-item" href="#">
...
$today = date('Y-m-d');
$q="select * from  tblticket T, tblbus B,tbldriver D  where  B.Bus_id=T.Bus_id and D.D_id=T.D_id and T.T_date >= '$today'  and T.Tstatus='0'  order by T.T_date  LIMIT $offset, $records_per_page";
