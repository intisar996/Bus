...
$today = date('Y-m-d');
$q="select * from  tblpayment P, tblticket T, tblbus B,tbldriver D,tbipassanger I  where  P.Ticket_id=T.Ticket_id and T.Bus_id=B.Bus_id and T.D_id=D.D_id and P.pid='$UserID' and I.pid=P.pid order by P.booking_date   LIMIT $offset, $records_per_page";
...
if ($num > 0) {
	...
	while($row = mysqli_fetch_assoc($r)) {
        ...
        echo "<td>$pid</td>";
        echo "<td>$pname</td>";
        echo '<td><a href="printTicket.php?Ticket_id='.$Ticket_id .'" class="btn-Clear">Print</a></td>';
        echo '</tr>';
    }
