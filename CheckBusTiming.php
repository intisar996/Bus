...
$today = date('Y-m-d');
$q="select * from  tblticket T, tblbus B,tbldriver D  where  B.Bus_id=T.Bus_id and D.D_id=T.D_id and T.D_id='$D_id'  and T.T_date >= '$today' order by T.T_date DESC  LIMIT $offset, $records_per_page";
