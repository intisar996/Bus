...
.Register table {
 ...
 include('connect.php');
 $UserID=$_GET['D_id'];
 $q="select * from  tbldriver where D_id='$UserID'";
        ...
        <div class="container">
            <div class="row">
                <div class="Register">
                     ...
                     <hr>
                     <form   method="post" id="form2"   name="form2"  onsubmit="return validate(this);"  enctype="multipart/form-data" action="<?php echo "DriverUpdatePassword.php?D_id=$UserID";?>" >
                    <table>
                      <tr>
