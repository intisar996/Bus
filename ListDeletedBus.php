   ...
   <body class="main-layout">
      ...
      <div class="content">
        <div class="container-fluid">
            <div class="search">
            <form action="Search_DeletedBus.php" method="post">
                    <table class="tb-search">
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="ListDeletedBus.php"><input type="button" value="Clear"
                                        class="btn-Clear"></a>
                            </td>
                        </tr>
                    </table>
...
$query_count = "SELECT COUNT(*) AS total FROM tblbus";
$result_count = mysqli_query($con, $query_count);
$row_count = mysqli_fetch_assoc($result_count);
$total_records = $row_count['total'];
$total_pages = ceil($total_records / $records_per_page);

$q="select * from  tblbus where status='Deleted' order by Bus_Name LIMIT $offset, $records_per_page";
